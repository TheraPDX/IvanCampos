  ...
  Meteor.methods({
      'getStocks':function(){
          ...
          Stocks.remove({});
          var jsonURL = 'http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.quotes%20where%20symbol%20in%20(%22AAPL,AMZN,BABA,BAC,DIS,GOOG,GOOGL,NFLX,NKE,PANW,TSLA,YHOO%22)%0A%09%09&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys';
